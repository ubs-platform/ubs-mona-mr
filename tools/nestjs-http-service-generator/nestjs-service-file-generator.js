...
exports.NestjsServiceFileGenerator = void 0;
...
class NestjsServiceFileGenerator {
    static generateServiceClassStr(workDir, libraryPackageName, controller) {
        const className = `${controller.name}Service`;
        const necessaryImports = (0, templates_1.NESTJS_SERVICE_NECESSARY_IMPORTS)(workDir, libraryPackageName, controller.methods);
        const methods = controller.methods.map(method => (0, templates_1.NESTJS_SERVICE_METHOD)(method)).join('\n');
        return `${templates_1.NESTJS_SERVICE_HEADER}\n${necessaryImports}\n${(0, templates_1.NESTJS_SERVICE_FILE_CORE_HEAD)(className, controller.parentPath)}\n${methods}\n${templates_1.NESTJS_SERVICE_FILE_CORE_TAIL}`;
    }
...
exports.NestjsServiceFileGenerator = NestjsServiceFileGenerator;
//# sourceMappingURL=nestjs-service-file-generator.js.map